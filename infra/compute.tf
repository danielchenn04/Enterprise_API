...
# Allow execution role to pull secrets for env injection
    ...
    environment = [
      {
        ...
        value = "jdbc:postgresql://${aws_db_proxy.main.endpoint}:5432/${var.db_name}"
      },
      {
      ...
      {
        name  = "REDIS_URL"
        # ElastiCache with TLS requires rediss:// scheme
