...
# Single NAT Gateway in AZ-a (cost-optimised; add one per AZ for full HA)
...
resource "aws_security_group" "rds" {
  ...
  description = "Allow Postgres from RDS Proxy only"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "rds_proxy" {
  ...
  description = "Allow Postgres from ECS app tasks to RDS Proxy"
  vpc_id      = aws_vpc.main.id
  ...
  tags = { Name = "${var.app_name}-rds-proxy-sg" }
}

resource "aws_security_group" "redis" {
  name        = "${var.app_name}-redis-sg"
  description = "Allow Redis from ECS app tasks"
  vpc_id      = aws_vpc.main.id
